...
const itemTooltipMouseCoords = computed(
  () => store.state.itemTooltipMouseCoords
);
...
function handleMouseMove(e) {
  ...
  if (
    itemTooltipMouseCoords.value.x !== e.clientX ||
    itemTooltipMouseCoords.value.y !== e.clientY
  ) {
